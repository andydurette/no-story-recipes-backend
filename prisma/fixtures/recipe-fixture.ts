export const recipes = [
  ...
  {
    id: 20,
    displayUrl: 'pad-kra-pao',
    cuisine: ['ASIAN'],
    description: 'A dish consisting of pork, spices and a hint of lime',
    name: 'Pad Kra Pao',
    directionsAndIngredients: [
      {
        forDataSlug: 'sauce',
      ...
      },
      {
        ...
        directionList: [
          'Using a mortar and pestle, grind the Thai chili peppers, garlic, and mild red chili into a smooth paste. Heat 2 teaspoons of oil in a pan over medium heat and fry the chili-garlic paste for 1–2 minutes, or until fragrant.',
          'Add mushrooms and any other desired vegetables to the pan, and stir-fry for 2–3 minutes until slightly tender.',
          'Add the ground pork to the pan and cook, breaking it apart with a spatula, until it is fully browned. Pour in the prepared sauce and continue to stir-fry until the sauce thickens and evenly coats the meat.',
          'Remove the pan from heat and stir in fresh basil leaves until just wilted.',
          'To serve, plate rice first, spoon the pork stir-fry on top, add a squeeze of lime, and finish with a fried egg on top.',
        ],
      },
    ],
