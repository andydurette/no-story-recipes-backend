...
export const recipes = [
  ...
  },
  {
    ...
    directions: [
      ...
      'Divide batter between each muffin cup, filling all the way to the top. Bake at 425°F for 5 minutes, then, keeping the muffins in the oven, reduce the oven temperature to 350°F (177°C) and continue to bake for 25-26 minutes until the tops are lightly golden brown and centers are set. Stick a toothpick in the center of a muffin to test for doneness. If it comes out clean, the muffins are done.',
